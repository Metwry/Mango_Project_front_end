...
export const API_BASE_URL = readTextEnv("VITE_API_BASE_URL", DEFAULT_API_BASE_URL);
export const API_TIMEOUT_MS = readIntEnv("VITE_API_TIMEOUT_MS", DEFAULT_API_TIMEOUT_MS, {
  min: 1000,
  max: 120000,
});
...
export const AUTH_ENDPOINTS = Object.freeze({
  loginUrl: readTextEnv("VITE_AUTH_LOGIN_URL", joinBasePath(API_BASE_URL, "/login/")),
  tokenRefreshUrl: readTextEnv(
    "VITE_AUTH_TOKEN_REFRESH_URL",
    joinBasePath(API_BASE_URL, "/token/refresh/"),
  ),
  emailCode: readTextEnv("VITE_AUTH_EMAIL_CODE_ENDPOINT", DEFAULT_AUTH_EMAIL_CODE_ENDPOINT),
...
export const INVESTMENT_ENDPOINTS = Object.freeze({
  buy: readTextEnv("VITE_INVESTMENT_BUY_ENDPOINT", DEFAULT_INVESTMENT_BUY_ENDPOINT),
  sell: readTextEnv("VITE_INVESTMENT_SELL_ENDPOINT", DEFAULT_INVESTMENT_SELL_ENDPOINT),
});
...
export const STORE_REFRESH_CONFIG = Object.freeze({
  accounts: Object.freeze({
    intervalMinutes: readIntEnv("VITE_REFRESH_ACCOUNTS_INTERVAL_MINUTES", 10, { min: 1, max: 60 }),
    second: readIntEnv("VITE_REFRESH_ACCOUNTS_SECOND", 5, { min: 0, max: 59 }),
  }),
  investmentQuotes: Object.freeze({
    intervalMinutes: readIntEnv("VITE_REFRESH_INVESTMENT_INTERVAL_MINUTES", 10, { min: 1, max: 60 }),
    second: readIntEnv("VITE_REFRESH_INVESTMENT_SECOND", 30, { min: 0, max: 59 }),
  }),
  market: Object.freeze({
    intervalMinutes: readIntEnv("VITE_REFRESH_MARKET_INTERVAL_MINUTES", 10, { min: 1, max: 60 }),
...
export const FX_RATES_CONFIG = Object.freeze({
  ...
  staleMs: readIntEnv("VITE_FX_RATES_STALE_MS", 10 * 60 * 1000, { min: 1000, max: 24 * 60 * 60 * 1000 }),
  usdRatesEndpoint: readTextEnv("VITE_USD_RATES_ENDPOINT", "/user/markets/fx-rates/"),
});

export const DASHBOARD_WORTH_CONFIG = Object.freeze({
  displayCurrency: readTextEnv("VITE_DASHBOARD_DISPLAY_CURRENCY", "CNY").toUpperCase(),
...
export const DASHBOARD_TREND_CONFIG = Object.freeze({
  ...
  todayAutoRefresh: Object.freeze({
    intervalMinutes: readIntEnv("VITE_REFRESH_DASHBOARD_TREND_INTERVAL_MINUTES", 15, { min: 1, max: 240 }),
    second: readIntEnv("VITE_REFRESH_DASHBOARD_TREND_SECOND", 20, { min: 0, max: 59 }),
  }),
});
...
export const SEARCH_CONFIG = Object.freeze({
  marketPage: Object.freeze({
    debounceMs: readIntEnv("VITE_SEARCH_MARKET_DEBOUNCE_MS", 250, { min: 50, max: 5000 }),
    cacheLimit: readIntEnv("VITE_SEARCH_MARKET_CACHE_LIMIT", 50, { min: 10, max: 500 }),
  }),
  addPosition: Object.freeze({
    debounceMs: readIntEnv("VITE_SEARCH_ADD_POSITION_DEBOUNCE_MS", 250, { min: 50, max: 5000 }),
    dropdownHideDelayMs: readIntEnv("VITE_SEARCH_ADD_POSITION_HIDE_DELAY_MS", 120, { min: 0, max: 1000 }),
  }),
});
