...
<template>
  <div v-if="visible" ref="panelRef"
    class="trade-panel-surface rounded-2xl border border-gray-200 bg-white/97 p-3 shadow-[0_12px_32px_rgba(15,23,42,0.16)] backdrop-blur dark:border-gray-600 dark:bg-gray-800/95">
      ...
      <div>
        <div class="mb-1 flex items-center justify-between">
          ...
          <button v-if="!isBuy" type="button"
            class="button-base surface-chip !h-6 !rounded-lg !px-2 !py-0 !text-[11px] !font-semibold !bg-gray-100 !border-gray-200 dark:!bg-gray-700 dark:!border-gray-600"
